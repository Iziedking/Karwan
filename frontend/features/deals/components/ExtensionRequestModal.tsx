  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="karwan-sheet-enter max-h-[calc(100dvh-5rem)] min-h-0 w-full overflow-y-auto rounded-t-[22px] sm:h-auto sm:max-h-[calc(100dvh-3rem)] sm:w-[min(460px,calc(100vw-2rem))] sm:rounded-[18px]"
        style={{
