/// Barrel for the SKILL.md primitives. Every UI component built in Karwan
/// imports from here. See docs/SKILL.md for the full law and memory
/// `karwan_ui_skill.md` for the load-bearing rules.
