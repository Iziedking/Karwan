...
export const en: MessagesShape = {
  ...
  assistant: {
    ...
    send: 'Send',
    greeting: 'I can help you find supply, bring a deal, check your trade record, or move through Karwan.',
  ...
  activity: {
    signInGate: {
      tag: 'STREAM',
      body: 'Sign in to review your trade records and recent activity across Karwan.',
    },
    hero: {
    ...
    myMoney: {
      text: {
        ...
        agentTopUp: 'Added {amount} USDC to the {agent} trade account from the main account',
  ...
  directDealDetail: {
    ...
    funding: {
      ...
      protectedEyebrow: 'Protected payment',
    },
    fundingSafety: {
      settled: 'Settlement complete. The seller was paid in full.',
    ...
    terms: {
      ...
      deliveryHeldBody: 'Karwan flagged the delivery link and is holding it back until it is checked. Do not release payment until it clears.',
      ...
      deliveryReviewBody: 'The delivery check is not sure this fully matches your request. Open it and confirm before you release payment.',
      deliveryOkLabel: 'Reviewed, matches your request',
      deliveryOkBody: 'The delivery check found that the evidence matches your request. USDC stays protected until you release it.',
    ...
    evidenceReceipt: {
      ...
      commitmentLabel: 'Evidence fingerprint',
      refresh: 'Check delivery record again',
    },
    progress: {
      eyebrow: 'PROGRESS',
    ...
    settlementRecord: {
      ...
      kinds: {
        escrow_funding: 'Protected funding',
      ...
      next: {
        ...
        karwan: 'Karwan is checking the payment',
    ...
    actionPanel: {
      settled: {
        releasedFromDispute: 'Settled after review. The buyer released the protected funds to the seller.',
        autoReleased: 'Settled. The review window passed, so the final milestone released automatically and the trade history was updated.',
        normal: 'Settled. The seller has been paid in full and both trade histories were updated.',
        financed: 'Settled. The assigned receivable was paid to the financier and the financing record was closed.',
        cashoutTemplate: 'Cash out {amount} USDC →',
        settleTimeEyebrow: 'settled in',
  ...
  docsIndexPage: {
    ...
    twoWays: {
      ...
      direct: {
        label: 'Bring a deal.',
        body: 'You already have a counterparty. From the active workspace, name their wallet or email, set the terms, and send them for agreement. Review the live fee and exact total before funding escrow.',
      },
      matched: {
        label: 'Find supply.',
        body: 'You need a counterparty, supplier, or buyer. Post a request or publish what you offer. The market and bounded agents look for a fit, then bring you a proposal to approve.',
      },
    },
    getStarted: {
      title: 'Start with the trade you need',
      signIn: {
        label: 'Choose the workspace.',
        body: 'Sign in with a passkey, an email code, or your own wallet. Use your personal workspace by default, or switch to your owner-only business workspace when it is available.',
      },
      fund: {
      ...
      open: {
        ...
        body: 'Post what you need, publish what you offer, name a counterparty by wallet or email, or browse the market. Fund only after you have reviewed the final terms.',
      },
    },
    next: {
  ...
  howItWorksPage: {
    ...
    directDeal: {
      ...
      title: 'When you already know the other side',
    ...
    stake: {
      eyebrow: 'Trade record and stake',
      title: 'Reputation with evidence',
      body: 'Completed trades, available evidence, and stake inform the reputation view. The score is tied to the customer identity and trade history, not a promise that every future trade is safe.',
