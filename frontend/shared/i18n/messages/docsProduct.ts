...
const en: DocsProductCopy = {
  ...
  roadmap: {
    title: 'Roadmap',
    lede: 'What ships next, in order. Dates are targets.',
    now: 'Now',
    milestones: [
      ...
      { when: '25 October 2026', title: 'Deals on mainnet', body: 'The escrow, deal board and stake contracts released on Arc mainnet, so real deals can settle.' },
      { when: 'December 2026', title: 'Arbiter and external audit', body: 'An arbiter for deals where one side goes silent, using the delivery evidence, and an external audit of the contracts that hold money.' },
      { when: 'February 2027', title: 'Trade from anywhere', body: 'Start a protected deal from the page where the trade began, starting with X, plus recurring deals.' },
      { when: 'April 2027', title: 'Local payouts', body: 'Cash out USDC to a local bank account, one country at a time.' },
    ],
    later: 'Also planned',
    laterItems: ['Mobile app after the mainnet release', 'Paid data access through x402', 'File delivery inside a deal', 'More languages'],
    note: 'Dates move if testing or security review needs more time. We say so here when they do.',
...
const ar: DocsProductCopy = {
  ...
  roadmap: {
    title: 'خارطة الطريق',
    lede: 'ما سيأتي تاليًا، بالترتيب. التواريخ أهداف.',
    now: 'الآن',
    milestones: [
      ...
      { when: '25 أكتوبر 2026', title: 'الصفقات على الشبكة الرئيسية', body: 'إطلاق عقود الضمان ولوحة الصفقات والرهن على الشبكة الرئيسية لـ Arc لتتم تسوية صفقات حقيقية.' },
      { when: 'ديسمبر 2026', title: 'المحكّم والتدقيق الخارجي', body: 'محكّم للصفقات التي يصمت فيها أحد الطرفين اعتمادًا على أدلة التسليم، وتدقيق خارجي للعقود التي تحتفظ بالمال.' },
      { when: 'فبراير 2027', title: 'التداول من أي مكان', body: 'ابدأ صفقة محمية من الصفحة التي بدأت فيها التجارة، بدءًا من X، إضافة إلى الصفقات المتكررة.' },
      { when: 'أبريل 2027', title: 'السحب المحلي', body: 'اسحب USDC إلى حساب مصرفي محلي، دولة تلو الأخرى.' },
    ],
    later: 'مخطط أيضًا',
    ...
    note: 'قد تتغير التواريخ إذا احتاج الاختبار أو المراجعة الأمنية إلى وقت أطول. سنوضح ذلك هنا عندما يحدث.',
...
const fr: DocsProductCopy = {
  ...
  roadmap: {
    ...
    lede: 'Ce qui arrive ensuite, dans l’ordre. Les dates sont des objectifs.',
    now: 'Maintenant',
    milestones: [
      ...
      { when: '25 octobre 2026', title: 'Transactions sur le mainnet', body: 'Les contrats de séquestre, de tableau des transactions et de mise en jeu déployés sur le mainnet d’Arc, pour régler de vraies transactions.' },
      { when: 'Décembre 2026', title: 'Arbitre et audit externe', body: 'Un arbitre pour les transactions où une partie ne répond plus, fondé sur les preuves de livraison, et un audit externe des contrats qui détiennent l’argent.' },
      { when: 'Février 2027', title: 'Échanger depuis n’importe où', body: 'Lancez une transaction protégée depuis la page où l’échange a commencé, en commençant par X, avec des transactions récurrentes.' },
      { when: 'Avril 2027', title: 'Retraits locaux', body: 'Retirez des USDC vers un compte bancaire local, un pays à la fois.' },
    ],
    ...
    note: 'Les dates peuvent bouger si les tests ou l’audit de sécurité demandent plus de temps. Nous l’indiquerons ici le cas échéant.',
...
const hi: DocsProductCopy = {
  ...
  roadmap: {
    title: 'रोडमैप',
    lede: 'आगे क्या आ रहा है, क्रम से। तारीखें लक्ष्य हैं।',
    now: 'अभी',
    milestones: [
      ...
      { when: '25 अक्टूबर 2026', title: 'मेननेट पर सौदे', body: 'एस्क्रो, सौदा बोर्ड और स्टेक अनुबंध Arc मेननेट पर जारी, ताकि असली सौदे निपट सकें।' },
      { when: 'दिसंबर 2026', title: 'मध्यस्थ और बाहरी ऑडिट', body: 'उन सौदों के लिए मध्यस्थ जिनमें एक पक्ष चुप हो जाए, डिलीवरी सबूतों के आधार पर, और पैसा रखने वाले अनुबंधों का बाहरी ऑडिट।' },
      { when: 'फ़रवरी 2027', title: 'कहीं से भी व्यापार', body: 'जिस पेज पर व्यापार शुरू हुआ वहीं से सुरक्षित सौदा शुरू करें, पहले X से, साथ में दोहराए जाने वाले सौदे।' },
      { when: 'अप्रैल 2027', title: 'स्थानीय भुगतान', body: 'USDC को स्थानीय बैंक खाते में निकालें, एक-एक देश करके।' },
    ],
    ...
    note: 'टेस्टिंग या सुरक्षा समीक्षा में ज़्यादा समय लगे तो तारीखें बदल सकती हैं। ऐसा होने पर हम यहाँ बताएँगे।',
...
const sw: DocsProductCopy = {
  ...
  roadmap: {
    ...
    lede: 'Kinachokuja baadaye, kwa mpangilio. Tarehe ni malengo.',
    now: 'Sasa',
    milestones: [
      ...
      { when: '25 Oktoba 2026', title: 'Mikataba kwenye mainnet', body: 'Mikataba ya escrow, ubao wa mikataba na dhamana huzinduliwa kwenye mainnet ya Arc ili mikataba halisi ikamilike.' },
      { when: 'Desemba 2026', title: 'Msuluhishi na ukaguzi wa nje', body: 'Msuluhishi wa mikataba ambapo upande mmoja umenyamaza, kwa kutumia ushahidi wa uwasilishaji, na ukaguzi wa nje wa mikataba inayoshikilia pesa.' },
      { when: 'Februari 2027', title: 'Fanya biashara popote', body: 'Anzisha mkataba uliolindwa kutoka ukurasa ambapo biashara ilianzia, kuanzia X, pamoja na mikataba ya kujirudia.' },
      { when: 'Aprili 2027', title: 'Malipo ya ndani', body: 'Toa USDC kwenda akaunti ya benki ya ndani, nchi moja baada ya nyingine.' },
    ],
    later: 'Pia imepangwa',
    ...
    note: 'Tarehe zinaweza kubadilika ikiwa majaribio au ukaguzi wa usalama utahitaji muda zaidi. Tutasema hapa ikitokea.',
