// AUTO-GENERATED from forge artifact out/KarwanYieldDistributor.sol/KarwanYieldDistributor.json
// Contracts-v2 ABI. Activated at cutover (see contracts.ts flag selection).
export const yieldDistributorV2Abi = [
  {
    "type": "constructor",
    "inputs": [
      {
