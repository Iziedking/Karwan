...
/// @notice Deploys KarwanTreasury. On testnet TELLER, USYC, and ORACLE all point
///         at the deployed MockUSYC address. On mainnet they point at the real
///         Hashnote / Circle USYC Teller, token, and Chainlink-style oracle.
contract DeployTreasury is Script {
    function run() external {
        address usdc = vm.envOr("USDC_ADDR", address(0x3600000000000000000000000000000000000000));
        // On testnet these three are the same MockUSYC address.
